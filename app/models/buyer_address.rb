class BuyerAddress
  ...
  with_options presence: true do
    ...
    validates :block, format: { with: /\A[0-9ぁ-んァ-ン一-龥]/, message: "is invalid. Input full-width characters." }
    validates :phone_number, format: { with: /\A\d{11}\z/, message: "is invalid. Input full-width characters."}
    validates :user_id
    validates :item_id
    validates :token
  end
